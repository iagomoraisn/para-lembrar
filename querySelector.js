//SELETORES E RESPETIVOS RESULTADOS
...
// todos os elemntos que contém o atributo NAME e cujo value seja TEXTO
el = document.querySelectorAll('[name="texto"]')

//todos os elementos que contém o atributo class e cujo value tem
